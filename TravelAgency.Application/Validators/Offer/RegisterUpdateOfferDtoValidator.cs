...
{
    public class RegisterUpdateOfferDtoValidator: AbstractValidator<UpdateOfferDto>
    {
        private int _max_days = 30;
        public RegisterUpdateOfferDtoValidator(ITravelAgencyUnitOfWork unitOfWork)
        {
            RuleFor(p => p.Price)
                .GreaterThan(1)
                .LessThan(100000);
